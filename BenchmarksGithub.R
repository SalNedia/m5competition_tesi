...
#Read data
sales <- read.csv("data/sales_train_validation.csv", stringsAsFactors = F)
calendar <- read.csv("data/calendar.csv", stringsAsFactors = F) ; calendar$date <- as.Date(calendar$date)
prices <- read.csv("data/sell_prices.csv", stringsAsFactors = F)
...
sales_out <- read.csv("data/sales_test_validation.csv", stringsAsFactors = F)
